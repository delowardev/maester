...
if ( ! function_exists( 'maester_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function maester_posted_on() {
...
if ( ! function_exists( 'maester_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'maester_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function maester_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $enable_single_blog_tag && $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'maester' ) . '</span>', wp_kses(
					$tags_list,
					array(
						"a" => array(
							"href" => array(),
...
if ( ! function_exists( 'maester_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function maester_post_thumbnail() {
